...
abstract final class AppText {
  ...
  static const _values = <String, Map<String, String>>{
    'vi': {
      ...
      'station_code_hint': 'Gửi mã này cho nhà sản xuất khi cần trích xuất ghi âm.',
      'station_code_copied': 'Đã chép mã trạm',
      'copy': 'Chép',
    ...
    'en': {
      ...
      'station_code_hint': 'Send this code to the manufacturer when you need recordings extracted.',
      'station_code_copied': 'Station code copied',
      'copy': 'Copy',
